...
public class multiplication extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button valider = (Button) findViewById(R.id.m_valider);
        final NumberPicker np = (NumberPicker) findViewById(R.id.m_num);
        ...
        valider.setOnClickListener(new View.OnClickListener() {
                                       ...
                                       public void onClick(View v) {
                                           ...
                                           Intent intent = new Intent(multiplication.this, multiplication_1.class);
