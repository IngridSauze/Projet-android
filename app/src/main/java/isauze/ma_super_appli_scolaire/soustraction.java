...
public class soustraction extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.soustraction);

        // Récupérer les objets de l'arbre graphique avec leur id
        final Button valider = (Button) findViewById(R.id.s_valider);
        final NumberPicker np = (NumberPicker) findViewById(R.id.s_num);
        ...
        valider.setOnClickListener(new View.OnClickListener() {
                                       ...
                                       public void onClick(View v) {
                                           ...
                                           Intent intent = new Intent(soustraction.this, soustraction_1.class);
