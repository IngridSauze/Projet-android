...
public class soustraction_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText edit1  = (EditText) findViewById(R.id.s1_set1) ;
        final EditText edit2  = (EditText) findViewById(R.id.s1_set2) ;
        final EditText edit3  = (EditText) findViewById(R.id.s1_set3) ;
        final EditText edit4  = (EditText) findViewById(R.id.s1_set4) ;
        final EditText edit5  = (EditText) findViewById(R.id.s1_set5) ;
        final EditText edit6  = (EditText) findViewById(R.id.s1_set6) ;
        final EditText edit7  = (EditText) findViewById(R.id.s1_set7) ;
        final EditText edit8  = (EditText) findViewById(R.id.s1_set8) ;
        final EditText edit9  = (EditText) findViewById(R.id.s1_set9) ;
        final EditText edit10  = (EditText) findViewById(R.id.s1_set10) ;

        final TextView texte1 = (TextView) findViewById(R.id.s1_1) ;
        final TextView texte2 = (TextView) findViewById(R.id.s1_2) ;
        final TextView texte3 = (TextView) findViewById(R.id.s1_3) ;
        final TextView texte4 = (TextView) findViewById(R.id.s1_4) ;
        final TextView texte5 = (TextView) findViewById(R.id.s1_5) ;
        final TextView texte6 = (TextView) findViewById(R.id.s1_6) ;
        final TextView texte7 = (TextView) findViewById(R.id.s1_7) ;
        final TextView texte8 = (TextView) findViewById(R.id.s1_8) ;
        final TextView texte9 = (TextView) findViewById(R.id.s1_9) ;
        final TextView texte10 = (TextView) findViewById(R.id.s1_10) ;
    ...
    public boolean test_soustraction(int table, int r, int resultat) {
        return (r - table) == resultat ;
    }
}
