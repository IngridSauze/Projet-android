...
public class validation_compte extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button accueil = (Button) findViewById(R.id.v_accueil) ;
        Button exercices = (Button) findViewById(R.id.v_exercices) ;
        TextView texte = (TextView) findViewById(R.id.v_texte) ;
